...
def dbshell(context, query="", input="", output=""):
    ...
    if "docker-compose.mysql.yml" in context.{{cookiecutter.plugin_name}}.compose_files:
    ...
    elif "docker-compose.postgres.yml" in context.{{cookiecutter.plugin_name}}.compose_files:
        command += [
            "--",
            service,
            "psql",
