...
from {{ cookiecutter.app_name }}.diffsync.adapters import {{ cookiecutter.system_of_record_camel }}RemoteAdapter
...
class Test{{ cookiecutter.system_of_record_camel }}RemoteAdapterTestCase(TransactionTestCase):
    """Test {{ cookiecutter.system_of_record_camel }}RemoteAdapter class."""
    ...
    def setUp(self):  # pylint: disable=invalid-name
        ...
        self.{{ cookiecutter.system_of_record_slug }} = {{ cookiecutter.system_of_record_camel }}RemoteAdapter(job=self.job, sync=None, client=self.{{ cookiecutter.system_of_record_slug }}_client)
