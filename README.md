...
- [`nautobot-app-private`](https://github.com/nautobot/cookiecutter-nautobot-app/tree/develop/nautobot-app-private) - A template for creating a new **private (licensed) Nautobot App** distributed through Network to Code's private Artifactory repository. Ships a `COPYRIGHT` notice (no open-source LICENSE), no PyPI publishing, and a documentation site stripped of GitHub-related content. Release artifacts are still attached to the GitHub release as a backup for Artifactory.
