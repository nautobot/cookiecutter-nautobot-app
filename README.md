...
- [`nautobot-app-private`](https://github.com/nautobot/cookiecutter-nautobot-app/tree/develop/nautobot-app-private) - A template for creating a new **private (licensed) Nautobot App** distributed exclusively through Network to Code's private Artifactory repository. Ships a `COPYRIGHT` notice (no open-source LICENSE), no PyPI/GitHub release publishing, and a documentation site stripped of GitHub-related content.
